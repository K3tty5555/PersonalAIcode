...
import { Package, Crown, Calendar, ArrowUpRight, ExternalLink } from 'lucide-react';
      ...
      <div className="max-w-5xl mx-auto px-6">
        ...
        <div className="flex items-center justify-between mb-12">
          <div>
            ...
            <p className="text-gray-500 mt-2">万代 BANDAI & Hot Toys 精选</p>
          </div>
          ...
          <div className="bg-white rounded-3xl p-6 shadow-sm">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500">高达 & 假面骑士系列</p>
              </div>
            </div>
          ...
          <div className="bg-white rounded-3xl p-6 shadow-sm">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500">高端收藏级人偶</p>
              </div>
            </div>
